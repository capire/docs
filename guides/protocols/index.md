...
- **MCP**: Model Context Protocol (MCP) is an open protocol that enables seamless integration between LLM applications and external data sources and tools. <Beta />
...
- [Core Data APIs](core-data-apis.md) <!-- UNRELEASED -->
- [OData APIs](odata.md)
- [OpenAPI](openapi.md)
