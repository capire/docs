...
If your application is [importing models from a reuse package](../integration/composition), that package comes with its own language bundles for localization. These are applied upon import, so they can be overridden in your models as well as in your language bundles and their translations.
