...
3. Test-drive locally:
   ...
   [Learn more about Automatic Bindings by `cds watch`](../integration/composition#bindings-via-cds-watch){.learn-more}
...
cds:
  ...
  remote.services: # [!code ++]
    OrdersService: # [!code ++]
      name: sap.capire.orders.api.OrdersService # [!code ++]
      type: "odata-v4" # [!code ++]
      http: # [!code ++]
    ...
    ReviewsService: # [!code ++]
      name: sap.capire.reviews.api.ReviewsService # [!code ++]
      type: "odata-v4" # [!code ++]
      destination: # [!code ++]
...
```json [Java]
{
  "routes": [
    ...
    { // [!code ++]
      "source": "^/odata/v4/sap.capire.orders.api.OrdersService/", // [!code ++]
      "destination": "orders-api", // [!code ++]
      "csrfProtection": true // [!code ++]
    }, // [!code ++]
    { // [!code ++]
      "source": "^/odata/v4/sap.capire.reviews.app.ReviewsService/", // [!code ++]
      "destination": "reviews-api", // [!code ++]
      "csrfProtection": true // [!code ++]
    }, // [!code ++]
    { // [!code ++]
      "source": "^/odata/v4/sap.capire.reviews.api.ReviewsService/", // [!code ++]
      "destination": "reviews-api", // [!code ++]
      "csrfProtection": true // [!code ++]
    } // [!code ++]
  ]
