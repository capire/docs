...
The following mapping is used during the import of an external service API, see [Using Services](../../guides/services/consuming-services#external-service-api). In addition, the [Mapping of CDS Types](../../guides/protocols/odata#type-mapping) shows import-related mappings.
