...
The following mapping is used during the import of an external service API, see [Using Services](../../guides/services/using-services#external-service-api). In addition, the [Mapping of CDS Types](../../guides//advanced/odata#type-mapping) shows import-related mappings.
