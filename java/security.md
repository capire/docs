...
Instead of using the same role, expose dedicated CDS services to technical clients which aren't accessible to business users and vica verse.
:::


#### How to Authorize Callbacks

For bidirectinal communication, callbacks from the reuse service to the CAP service need to be authorized as well.
