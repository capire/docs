...
The CQN query APIs enable [late-cut microservices](../../guides/services/providing-services#late-cut-microservices) with simplified mocking capabilities. Regarding multitenant applications, these APIs keep you extensible, even towards remote APIs. In addition, they free developers from having to map CQN to OData themselves.
...
::: tip
To learn more about how to use _Remote Services_ end to end read the [Consuming Services cookbook](../../guides/services/using-services).
:::
...
To learn more about this, have a look at the section [Importing Service Definitions](../../guides/services/using-services#import-api).
:::
...
Refer to the [Integrate and Extend guide](../../guides/services/using-services#integrate-and-extend) for more details.
:::
...
To read a [media elements](/guides/services/providing-services#annotating-media-elements) of an entity, you need to create a CQN statement that targets a single instance of this entity via its primary key in its `from()` clause and include _one_ media element in the select list.
...
The OData call generated by CAP is an equivalent of the direct [read of the media property value](/guides/services/providing-services#reading-media-resources)
...
You write [media elements](/guides/services/providing-services#annotating-media-elements) with `Update` statements. Statements still need to target a single entity instance and
...
Updates are translated to OData requests to [update the media element value](/guides/services/providing-services#updating-media-resources) or [delete the value](/guides/services/providing-services#deleting-media-resources).
...
[Learn more about using destinations](../../guides/services/using-services#using-destinations){.learn-more}
