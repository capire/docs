...
**Event Topics**: Topics organize events into logical channels and are responsible for routing. Topics can be explicitly defined as anootation or derived from service and event names.
