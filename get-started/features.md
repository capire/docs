...
| [Run and restart on file changes](./in-a-nutshell)                                  | `cds watch`                |
...
> Run `cds help <command>` to find details about an individual command. Use `cds version` to check the version that you've installed. To know what is the latest version, see the [Release Notes](/releases/index.md) for CAP.
...
| [Dynamic Extensibility](../guides/extensibility/index.md)                                                          | <X/>  |  <X/>   | <X/> |
...
| [SAP Cloud Application Event Hub](../guides/events/event-hub)                                                                                         | <Na/> | <X/><br><sup>plugin</sup> | <X/><br><sup>plugin</sup> |
| [SAP Event Mesh](../guides/events/event-mesh)                                                                                                            | <Na/> |           <X/>            |           <X/>            |
...
| [Support for other UI technologies, for example Vue.js](./in-a-nutshell#vue)  <sup>1</sup> | <X/> |  <X/>   | <X/> |
...
|                                                                                          |      |
|------------------------------------------------------------------------------------------|:----:|
| [Tenant-Specific Extensions](../guides/extensibility/index.md)                           | <X/> |
