...
## [Consuming Services](guides/services/using-services)
  ...
  ### [Introduction](guides/services/using-services#introduction)
  ### [Import APIs](guides/services/using-services#external-service-api)
  ### [Mocking](guides/services/using-services#local-mocking)
  ### [Querying](guides/services/using-services#execute-queries)
...
## [Security & Data Privacy](guides/security/index.md)
  ...
  ### [Data Protection](guides/security/data-protection)
  ### [Data Privacy](guides/security/data-privacy)
  ### [Personal Data](guides/security/dpp-annotations)
  ### [Audit Logging](guides/security/dpp-audit-logging)
  ### [Personal Data Management](guides/security/dpp-pdm)
...
# [Java](java/_menu.md)
# [Tools](tools/_menu.md)
# [Plugins](plugins/_menu.md)
